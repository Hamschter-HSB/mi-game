class VictoryScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('Victory', 'assets/img/ui/Victory.png');
  }
  ...
  create() {
    ...
    const bg2 = this.add.image(0, 0, 'Victory').setOrigin(0);
    const texture2 = this.textures.get('Victory').getSourceImage();
